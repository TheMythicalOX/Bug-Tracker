...
const Projects = () => {
    ...
    const [projectDisplays, setProjectDisplays] = useState < React.ReactNode[] | null > (null);
    const [proj, setProj] = useState < ProjectSub > ({name: "", desc: "", pwd: "", pwd2: ""});
    ...
    const handleCreateProject = async (e : React.FormEvent) => {
        ...
        setError(VarifySub.varifyCreateProject(proj.name, proj.desc, proj.pwd, proj.pwd2));
