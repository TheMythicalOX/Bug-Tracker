...
const Navbar = (props : {
    ...
    switch (props.current) {
        case "Home": first = disabled;
            break;
        case "Projects": second = disabled;
            break;
        case "Account": third = disabled;
            break;
        default:
            break;
    }
        ...
        <>
            <div className="dash-grid-area-1 row-span-1">
                <div className={`bg-stone-300 col-span-2 h-screen grid grid-rows-10`}>
                    <div className={`shadow shadow-stone-400 grid row-span-1 text-center items-center `}>
                        <h1>Logo</h1>
                    </div>
                            ...
                            <div onClick={
                                ...
                                <div onClick={
                                    ...
                                    <div className="grid gap-10 justify-center">
                                        <button className="bg-blue-500 text-2xl p-3 px-16 rounded-3xl"
                                            onClick={handleLogOut}>
                                            Logout
                                        </button>
                                        <button className="bg-stone-400 text-2xl p-3 px-16 rounded-3xl"
                                            onClick={
                                                () => {
                                                    setTryLogout(false);
                                                }
